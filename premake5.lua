workspace "iv-restored-death-music"
	configurations { "ReleaseIV", "DebugIV" }
	location "project_files"
   
project "iv-restored-death-music"
	kind "SharedLib"
	language "C++"
	...
	filter { "configurations:*IV" }
		...
		targetname "RestoredDeathMusicIV"
		debugdir "$(GTA_IV_DIR)"
		debugcommand "$(GTA_IV_DIR)/GTAIV.exe"
		postbuildcommands "copy /y \"$(TargetPath)\" \"$(GTA_IV_DIR)\\plugins\\RestoredDeathMusicIV.asi\""
